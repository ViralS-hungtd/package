  ...
  <div class="row">
    ...
    <div class="{{ $crud->getListContentClass() }}">
      <div class="" style="position: relative">
        @include('myvendor::buttons.create')
        ...
        @endif
        <div class="alert alert-success" style="display: none; position: absolute; text-align: center; top: -30px; right: 25%; width: 50%;"></div>
        ...
        <table id="crudTable" class="box table table-striped table-hover display responsive nowrap m-t-0" cellspacing="0">
          ...
          <div id="bottom_buttons" class="hidden-print">
            @include('myvendor::buttons.update')
...
@section('after_scripts')
  ...
  <script src="{{ asset('vendor/backpack/crud/js/createModal.js') }}"></script>
  <script src="{{ asset('vendor/backpack/crud/js/editModal.js') }}"></script>
